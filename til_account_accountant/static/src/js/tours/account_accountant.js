odoo.define('til_account_accountant.tour', function (require) {
    "use strict";
    ...
    tour.tours.account_tour.steps.splice(0, 3,
        ..._.map(tour.stepUtils.goToAppSteps('til_account_accountant.menu_accounting', _t('Go to invoicing')), step => _.extend(step, {auto: true})),
        {
    ...
    tour.register('account_accountant_tour', {
        ...
        [
            ...tour.stepUtils.goToAppSteps('til_account_accountant.menu_accounting', _t('Let’s automate your bills, bank transactions and accounting processes.')),
