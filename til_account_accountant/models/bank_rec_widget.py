    ...
    def _compute_amls_widget(self):
        for wizard in self:
            ...
            context = {
                ...
                # Views.
                'search_view_ref': 'til_account_accountant.view_account_move_line_search_bank_rec_widget',
                'tree_view_ref': 'til_account_accountant.view_account_move_line_list_bank_rec_widget',
            }
