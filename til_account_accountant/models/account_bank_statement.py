...
class AccountBankStatementLine(models.Model):
    ...
    def action_save_new(self):
        action = self.env['ir.actions.act_window']._for_xml_id('til_account_accountant.action_bank_statement_line_form_bank_rec_widget')
    ...
    def _action_open_bank_reconciliation_widget(self, extra_domain=None, default_context=None, name=None):
        ...
        return {
            ...
            'context': context,
            'search_view_id': [self.env.ref('til_account_accountant.view_bank_statement_line_search_bank_rec_widget').id, 'search'],
            'view_mode': 'kanban,list',
            'views': [
                (self.env.ref('til_account_accountant.view_bank_statement_line_kanban_bank_rec_widget').id, 'kanban'),
                (self.env.ref('til_account_accountant.view_bank_statement_line_tree_bank_rec_widget').id, 'list'),
            ],
    ...
    def _cron_try_auto_reconcile_statement_lines(self, batch_size=None):
        ...
        if nb_auto_reconciled_lines and has_more_st_lines_to_reconcile:
            self.env.ref('til_account_accountant.auto_reconcile_bank_statement_line')._trigger()
