        ...
        for column_group_key, column_group_options in report._split_options_per_column_group(options).items():
            ...
            if last_statement and not print_mode:
                reference_cells[column_group_key] = {
                    ...
                    'template': 'til_account_reports.bank_reconciliation_report_cell_template_link_last_statement',
            ...
            if last_statement:
                ...
                if not report_currency.is_zero(difference):
                    balance_cells[column_group_key].update({
                        'template': 'til_account_reports.bank_reconciliation_report_cell_template_unexplained_difference',
