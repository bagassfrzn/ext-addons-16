...
class AccountMove(models.Model):
    ...
    def action_open_tax_report(self):
        action = self.env["ir.actions.actions"]._for_xml_id("til_account_reports.action_account_report_gt")
    ...
    def _close_tax_period(self):
        ...
        tax_closing_activity_type = self.env.ref('til_account_reports.tax_closing_activity_type')
