...
class MulticurrencyRevaluationReportCustomHandler(models.AbstractModel):
    ...
    def _custom_line_postprocessor(self, report, options, lines):
        line_to_adjust_id = self.env.ref('til_account_reports.multicurrency_revaluation_to_adjust').id
        line_excluded_id = self.env.ref('til_account_reports.multicurrency_revaluation_excluded').id
    ...
    def action_multi_currency_revaluation_open_revaluation_wizard(self, context):
        ...
        form = self.env.ref('til_account_reports.view_account_multicurrency_revaluation_wizard', False)
        return {
    ...
    def action_multi_currency_revaluation_open_general_ledger(self, options, params):
        ...
        general_ledger_options = self.env.ref('til_account_reports.general_ledger_report')._get_options(options)
        general_ledger_options['unfolded_lines'] = [account_line_id]

        general_ledger_action = self.env['ir.actions.actions']._for_xml_id('til_account_reports.action_account_report_general_ledger')
