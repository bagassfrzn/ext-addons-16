...
class TestAgedPayableReport(TestAccountReportsCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.report = cls.env.ref('til_account_reports.aged_payable_report')
        cls.prefix_line_id = f'{cls._get_basic_line_dict_id_from_report_line_ref("til_account_reports.aged_payable_line")}|'
