...
class TestFinancialReport(TestAccountReportsCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.report = cls.env.ref('til_account_reports.balance_sheet')
    ...
    def test_financial_report_single_company(self):
        line_id = self._get_basic_line_dict_id_from_report_line_ref('til_account_reports.account_financial_report_bank_view0')
    ...
    def test_financial_report_horizontal_group(self):
        line_id = self._get_basic_line_dict_id_from_report_line_ref('til_account_reports.account_financial_report_receivable0')
